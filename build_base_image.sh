...
./apigw-emt-scripts-2.4.0/build_base_image.py \
  ...
  --os=centos7 \
  --out-image=$2/apim/apim_base$3:$1

# create latest tag
#docker tag $2/apim/apim_base$3:$1 $2/apim/apim_base$3:latest

# push image with release tag
#docker push $2/apim/apim_base$3:$1

# push same image using 'latest' tag
#docker push $2/apim/apim_base$3:latest
